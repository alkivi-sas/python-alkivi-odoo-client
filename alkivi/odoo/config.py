...
"""
Define endpoint to connect to odoo
...
1. Current working directory: ``./odoo.conf``
2. Current user's home directory ``~/.odoo.conf``
3. System wide configuration ``/etc/odoo.conf``
